# Sales Audit System Config - Operations & Batch Job Reference

Technical documentation of nightly batch processing cycles, C/Pro*C programs, restart/recovery threading, and RIB messaging interfaces for Sales Audit System Config.
...
- **`resa_sales_audit_system_config_batch`**: Core batch execution program. Processes records in multi-threaded chunks based on store/department threading settings.
