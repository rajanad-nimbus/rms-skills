...
|dealinc.pc|Calculate Weekly/Monthly Income Based on<br>Turnover|
|dealday.pc|Daily Posting of Deal Income to Stock &<br>General Ledgers|
...
|pload of Deals from 3rd Party|Systems)|
|---|---|
|**Module Name**|dealupld.pc|
|**Description**|Upload of Deals from 3<br>rd Party Systems|
