# Transaction Data - Operations & Batch Job Reference

Technical documentation of nightly batch processing cycles, C/Pro*C programs, restart/recovery threading, and RIB messaging interfaces for Transaction Data.
...
- **`rms_transaction_data_batch`**: Core batch execution program. Processes records in multi-threaded chunks based on store/department threading settings.
