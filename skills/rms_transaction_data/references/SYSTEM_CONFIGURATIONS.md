# RMS_TRANSACTION_DATA - System Options & Implementation Configurations

This reference documents the system options, parameter configuration flags, operational rules, and setup parameters for `rms_transaction_data`.
