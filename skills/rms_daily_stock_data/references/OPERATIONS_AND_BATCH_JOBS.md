# Daily Stock Data - Operations & Batch Job Reference

Technical documentation of nightly batch processing cycles, C/Pro*C programs, restart/recovery threading, and RIB messaging interfaces for Daily Stock Data.
...
- **`rms_daily_stock_data_batch`**: Core batch execution program. Processes records in multi-threaded chunks based on store/department threading settings.
